        ...
        <div className="navbar container mx-auto ">
          ...
          <div className="navbar-end">
            ...
            <div className="ml-3 hidden lg:flex items-center">
              <p className="text-sm font-semibold mr-2 cursor-pointer">Login</p>
              <a className="text-sm bg-linear-to-r from-indigo-500 to-purple-500 px-4 py-2 rounded-full font-semibold text-white cursor-pointer">
                Get Started
              </a>
            </div>
          </div>
